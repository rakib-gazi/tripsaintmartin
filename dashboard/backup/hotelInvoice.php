<?php 
    ...
    $note_icons = ['fa-regular fa-rectangle-list','fa-solid fa-database','fa-solid  fa-hourglass-half', 'fa-regular fa-circle-check','fa-solid fa-person',];
    $heading = ['Create Invoice','All Invoices','Due Invoices', 'Paid Invoices','Single Guest Invoices',];
    $nlinks = ['createHotelInvoice.php','allHotelInvoice.php','dueInvoices.php','paidInvoices.php','singleGuestInvoices.php',]
?>
...
<div class="flex">  
    ...
    <div class="w-4/5 p-4">
        ...
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-3xl font-bold  font-serif capitalize">Hotel Invoice</h1>
            <div class="flex justify-center items-center gap-x-2">
                <a href="dashboard.php" class="bg-cyan-950 hover:bg-slate-800 text-white transition duration-700 ease-in-out font-serif text-lg font-semibold px-8 py-1.5 rounded outline outline-1 outline-black">
                    <i class="fa-solid fa-long-arrow-alt-left me-4"></i>Dashboard
                </a>
            </div>
        </div>
