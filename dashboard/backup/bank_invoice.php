<?php 
    ...
    $bank_icons = ['fa-solid  fa-user','fa-solid  fa-hotel'];
    $heading = ['Add Bank Invoice','All Bank Invoices'];
    $nlinks = ['add_bank_invoice.php','all_bank_invoice.php']
?>
<div class="flex">  
        ...
        <div class="w-4/5 p-4">
            <div class="container mx-auto pt-24">
                <h1 class="text-3xl font-bold mb-4 font-serif capitalize">Bank Invoices</h1>
                <hr class="border border-black">	
                <div class="grid grid-cols-4 gap-4 mt-12 ps-12">
                <?php
                    foreach ($bank_icons as $index => $note_icon) {
                        $hline = $heading[$index];
                        $nlink = $nlinks[$index];
                    ?> 
