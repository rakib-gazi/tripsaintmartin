<?php 
    ...
    if (isset($_GET['hotelWiseSearch'])) {
        $search_data = hotelWiseSearch();
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <hr class="border border-black">  
                ...
                <form method="GET" class=" py-4 grid grid-cols-12 gap-x-4">
                    <div class="col-span-11">
                        <div class="grid grid-cols-4 gap-x-4">
                            ...
                            <div class=" flex justify-start items-center outline outline-1 ouline-black rounded cursor-pointer">
                                ...
                                <select name="hotel"  class=" p-1.5 bg-transparent w-full ps-2 focus:outline-none cursor-pointer">
                                    ...
                                    ?>
                                        <option value="<?php echo htmlspecialchars($hotel_name); ?>" 
                                            <?php echo (isset($_GET['hotel']) && $_GET['hotel'] == $hotel_name ? 'selected' : ''); ?> class="bg-cyan-950 text-white ">
                    ...
                    <button type="submit" name="hotelWiseSearch" class="bg-cyan-950 hover:bg-slate-800  text-white transition duration-700 ease-in-out font-serif text-lg font-semibold px-4 py-1  rounded outline outline-1 outline-black">Search
                    </button>
                </form>
