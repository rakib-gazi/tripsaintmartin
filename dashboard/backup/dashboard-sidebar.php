<!-- Sidebar -->
 <?php 
    ...
    $items = ['Dashboard','Add Reservation', $reservationItem,'All Reservations','Hotel Invoice','Bank Invoice','Profile','Settings'];
    ...
    $links = ['dashboard','reservation','current_reservation','all_reservation','hotelInvoice','bank_invoice','profile','settings'];
 ?>
<div class="w-1/6 bg-slate-800 h-screen p-4 text-white  pt-20 sticky top-0">
    <ul class="ms-4">
        <?php
